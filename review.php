    ...
    <div class="container" align="center" style="max-width: 800px;">
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php" method="post">
                <div class="container">
                    <i calss="fa fa-star fa-2x star-rev" data-index="1"></i>
                    <i calss="fa fa-star fa-2x star-rev" data-index="2"></i>
                    <i calss="fa fa-star fa-2x star-rev" data-index="3"></i>
                    <i calss="fa fa-star fa-2x star-rev" data-index="4"></i>
                    <i calss="fa fa-star fa-2x star-rev" data-index="5"></i>
                </div>
            ...
            <div class="form-group">
                <button class="btn btn-outline-danger" id="review-submit" name="review-submit" type="submit" style="width: 100%;">Reviews</button>
            </div>
        </form>
        </div>
</div>
